        ...
        <motion.form initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ duration: 0.3 }} className="mt-5">
          <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-2">
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-2 text-blue-500 text-nowrap">
                asklfjlfksjdo School
              </p>
            </div>

            <div className="flex flex-col items-center justify-center text-center">
              <span span class="p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
            ...
            <div className="flex flex-col items-center justify-center text-center">
              <span className="p-3 text-2xl text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                <FaGithub/>
              </span>
